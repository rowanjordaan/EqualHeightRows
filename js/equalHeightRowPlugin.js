var equalHeightRows = function(options){
    ...
    var _this = this;
    _this.selector = $(settings.itemsSelector);

    /*
    *  Execute equal height calculation
    */
    _this.execute = function($selector){
    ...
    */
    ...
    _this.reload = function(){
        ...
        return _this.execute(_this.selector);
    };
};
